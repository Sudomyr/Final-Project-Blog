...
gulp.task("app-css", function() {
	return gulp.src([
		...
		"src/styles/blog-styles.less",
		"src/styles/contacts-styles.less",
		"src/styles/archive-styles.less"
		])
		.pipe(less())
		.pipe(nano())
...
gulp.task("default", ["html", "app-css", "fonts", "images", "vendor-css", "vendor-js", "app-js", "json", "watch"]);
